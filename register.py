...
class register:
    ...
    def accept_register_new_user(self):
        ...
        self.mycursor.execute('INSERT INTO face_id_data3 (login_id, face_image, Present,Department,sem,Arrived) VALUES (%s, %s, %s,%s,%s,%s)', 
                               (login_id, image_bytes, '0',department,sem,"None"))
