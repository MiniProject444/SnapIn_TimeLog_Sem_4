...
INSERT INTO time_tabel (admin_id,time,duratin,day,subject,branch,sem) VALUES ('103','09:30:00','3','Friday','MP','EXTC','4');
...
CREATE TABLE IF NOT EXISTS facedata4 (admin_id VARCHAR(10),branch VARCHAR(100),subject VARCHAR(100),sem VARCHAR(100), excel_data LONGBLOB, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);
INSERT INTO facedata4 (admin_id,branch,subject,sem,excel_data) VALUES ('101','CSE','AOA','4',NULL);
INSERT INTO facedata4 (admin_id,branch,subject,sem,excel_data) VALUES ('101','CSE','Python','4',NULL);
...
INSERT INTO facedata4 (admin_id,branch,subject,sem,excel_data) VALUES ('103','EXTC','MP','4',NULL);
CREATE TABLE IF NOT EXISTS rollbk (admin_id VARCHAR(255), time VARCHAR(255), duratin VARCHAR(255), day VARCHAR(255), subject VARCHAR(255), branch VARCHAR(244), sem VARCHAR(233));